...
void propag(int nod,int st,int dr){
	...
	lazy[2 * nod] += lazy[nod];aint[2 * nod].first += lazy[nod];aint[2 * nod].second += lazy[nod];
	lazy[2 * nod + 1] += lazy[nod];aint[2 * nod + 1].first += lazy[nod];aint[2 * nod + 1].second += lazy[nod];
	lazy[nod] = 0;
}
